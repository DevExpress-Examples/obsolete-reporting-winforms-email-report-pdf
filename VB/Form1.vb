	...
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			Try
				...
				Dim att As Attachment = New Attachment(mem, "TestReport.pdf", "application/pdf")
				...
				Dim smtp As SmtpClient = New SmtpClient("smtp.somewhere.com")
				smtp.Send(mail)
			...
			Catch ex As Exception
				MessageBox.Show(Me, "Error sending a report." & Constants.vbLf + ex.ToString())
			End Try
		End Sub
	End Class
End Namespace